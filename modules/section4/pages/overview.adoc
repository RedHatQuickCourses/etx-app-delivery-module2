...
A. A desktop IDE installed on developer laptops.

B. A cloud-based development environment running on OpenShift that provides standardized workspaces.

C. A Continuous Integration platform.

D. A Git repository hosting service.
