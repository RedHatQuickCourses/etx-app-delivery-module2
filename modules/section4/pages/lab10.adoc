...
= Lab 10: Red Hat Openshift Dev Spaces Workspace
:navtitle: Lab 10: Red Hat Openshift Dev Spaces Workspace

In this lab, you'll create a Red Hat Openshift Dev Spaces workspace for the **ETX App Base** application, configure it with a custom **Devfile**, and verify that it is ready for cloud-native application development.
...
. From the Dev Spaces dashboard, click btn:[Create Workspace] and select *Import from Git*.
+
.Red Hat Openshift Dev Spaces Home Page(_Click the image to view it in full size in a new browser tab_)
image::import.png[link={imagesdir}/import.png, width=500]
+
...
----
+
.Sample Git URL(_Click the image to view it in full size in a new browser tab_)
image::git.png[link={imagesdir}/git.png, width=500]
+
. Click btn:[Create & Open].
. If prompted, authorize GitLab access using OAuth.
+
.Authorize GitLab Access(_Click the image to view it in full size in a new browser tab_)
image::auth.png[link={imagesdir}/auth.png, width=500]
+
...
== Configure Git inside your Workspaces

After the workspace opens, configure your Git identity.

Open a terminal by clicking btn:[hamburger icon] and selecting menu:Terminal[New Terminal].

.Terminal Option(_Click the image to view it in full size in a new browser tab_)
image::terminal.png[link={imagesdir}/terminal.png, width=500]
...
NOTE: Make sure to execute below command inside the newly opened terminal in your workspaces.
...
.Workspace Menu(_Click the image to view it in full size in a new browser tab_)
image::workspace.png[link={imagesdir}/workspace.png, width=500]

. Open the options menu and select *Delete Workspace*.

.Delete Option(_Click the image to view it in full size in a new browser tab_)
image::deleteworkspace.png[link={imagesdir}/deleteworkspace.png, width=500]
...
Open a terminal in your newly created workspace.
