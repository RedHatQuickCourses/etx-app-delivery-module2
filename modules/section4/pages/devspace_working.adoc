...
. The developer signs in to the Dev Spaces Dashboard using their OpenShift credentials.
. Dev Spaces authenticates the user through OpenShift OAuth.
...
. Dev Spaces creates a **DevWorkspace** resource.
