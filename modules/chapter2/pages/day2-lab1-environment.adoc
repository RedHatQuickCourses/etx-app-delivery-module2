= Lab 1: Software Factory Environment Overview
:navtitle: Software Factory Environment Overview

== Overview

This workshop provides a pre-configured OpenShift environment with foundational infrastructure services.
You will deploy application platform services (Dev Spaces, Tekton, Argo CD) and build a complete CI/CD pipeline.
