...
= Lab 9: GitLab Integration and Shared Secrets
...
. Open **GITLAB_URL** from your lab information page and authenticate with your platform-developer/openshift credentials.
. Click your avatar in the upper-right corner.
. Select **menu:Edit** profile:
+
image::edit.png[width=300]

. Select btn:[menu:Access > Applications] to open the User Settings applications page.
+
...
First, obtain an API key from the https://maas-rhdp-frontend.apps.maas.redhatworkshops.io[Red Hat Demo Platform MaaS^].
...
+
image::maas_sub.png[Dev Spaces Operator installed]
